...
#> Chain 1
#> Chain 1 Informational Message: The current Metropolis proposal is about to be rejected because of the following issue:
#> Chain 1 Exception: modgirt_probit_model_namespace::log_prob: Sigma_theta is not positive definite. (in '/var/folders/y0/zvly4kr52k73ww89tjtm4_yw0000gn/T/Rtmpckmz3U/model-9c4519411f10.stan', line 49, column 2 to column 28)
#> Chain 1 If this warning occurs sporadically, such as for highly constrained variable types like covariance matrices, then the sampler is fine,
#> Chain 1 but if this warning occurs often then your model may be either severely ill-conditioned or misspecified.
#> Chain 1
#> Chain 1 Informational Message: The current Metropolis proposal is about to be rejected because of the following issue:
...
#> Chain 2 but if this warning occurs often then your model may be either severely ill-conditioned or misspecified.
#> Chain 2
#> Chain 1 finished in 369.8 seconds.
#> Chain 2 finished in 417.6 seconds.
#> 
#> Both chains finished successfully.
#> Mean chain execution time: 393.7 seconds.
#> Total execution time: 417.8 seconds.
...
#>  Length   :1830   Min.   :-330740.21   Min.   :-330740.44   Min.   : 0.00000   Min.   : 0.00000  
#>  N.unique :1830   1st Qu.:     -0.13   1st Qu.:     -0.17   1st Qu.: 0.02869   1st Qu.: 0.02686  
#>  N.blank  :   0   Median :      0.09   Median :      0.09   Median : 0.11697   Median : 0.11715  
#>  Min.nchar:   4   Mean   :   -180.30   Mean   :   -180.31   Mean   : 0.30170   Mean   : 0.32801  
#>  Max.nchar:  26   3rd Qu.:      0.83   3rd Qu.:      0.88   3rd Qu.: 0.49056   3rd Qu.: 0.50558  
#>                   Max.   :      4.38   Max.   :      4.34   Max.   :18.35085   Max.   :18.96987  
#>                                                                                                  
#>        q5                  q95                  rhat           ess_bulk           ess_tail     
#>  Min.   :-330769.45   Min.   :-330710.78   Min.   :0.9965   Min.   :   2.979   Min.   : 22.49  
#>  1st Qu.:     -1.09   1st Qu.:      0.00   1st Qu.:1.0039   1st Qu.:   5.208   1st Qu.: 81.44  
#>  Median :     -0.04   Median :      0.67   Median :1.0311   Median : 112.282   Median :212.35  
#>  Mean   :   -180.76   Mean   :   -179.82   Mean   :1.2020   Mean   : 231.968   Mean   :210.91  
#>  3rd Qu.:      0.54   3rd Qu.:      1.73   3rd Qu.:1.3141   3rd Qu.: 397.499   3rd Qu.:331.16  
#>  Max.   :      3.98   Max.   :      4.88   Max.   :1.8698   Max.   :1349.485   Max.   :474.61  
...
#> * iteration: 1 
#>    -----  objective function = 506.546 ----- 
#> 
#> * iteration: 2 
#>    -----  objective function = 47.466 ----- 
#> 
#> * iteration: 3 
#>    -----  objective function = 46.822 ----- 
#> 
#> * iteration: 4 
#>    -----  objective function = 46.822 -----
...
#> Warning: The ESS has been capped to avoid unstable estimates.
#>       variable         mean                median                 sd                mad          
#>  Length   :1153   Min.   :-330740.21   Min.   :-330740.44   Min.   : 0.01105   Min.   : 0.01053  
#>  N.unique :1153   1st Qu.:     -0.30   1st Qu.:     -0.30   1st Qu.: 0.03033   1st Qu.: 0.02926  
#>  N.blank  :   0   Median :      0.47   Median :      0.47   Median : 0.08615   Median : 0.08117  
#>  Min.nchar:   4   Mean   :   -286.20   Mean   :   -286.20   Mean   : 0.15712   Mean   : 0.15209  
#>  Max.nchar:  17   3rd Qu.:      1.53   3rd Qu.:      1.53   3rd Qu.: 0.20933   3rd Qu.: 0.20723  
#>                   Max.   :      4.38   Max.   :      4.34   Max.   :18.35085   Max.   :18.96987  
#>        q5                  q95                  rhat           ess_bulk           ess_tail     
#>  Min.   :-330769.45   Min.   :-330710.78   Min.   :0.9965   Min.   :   8.742   Min.   : 27.08  
#>  1st Qu.:     -0.64   1st Qu.:      0.00   1st Qu.:1.0010   1st Qu.: 172.224   1st Qu.:244.26  
#>  Median :      0.26   Median :      0.65   Median :1.0039   Median : 342.694   Median :332.69  
#>  Mean   :   -286.45   Mean   :   -285.94   Mean   :1.0176   Mean   : 377.609   Mean   :303.62  
#>  3rd Qu.:      1.19   3rd Qu.:      1.80   3rd Qu.:1.0092   3rd Qu.: 526.108   3rd Qu.:380.26  
#>  Max.   :      3.98   Max.   :      4.88   Max.   :1.1837   Max.   :1349.485   Max.   :566.90
...
#> ℹ The deprecated feature was likely used in the ggdist package.
#>   Please report the issue at <https://github.com/mjskay/ggdist/issues>.
