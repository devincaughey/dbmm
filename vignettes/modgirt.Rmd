...
head(data)
#> # A tibble: 6 × 43
#>   serial  year wtfactor rsex   popq  country agecat3 location hhincqe university index taxspendv2 welfhelpv2
#>   <chr>  <dbl>    <dbl> <fct>  <fct> <fct>   <fct>   <fct>    <fct>        <dbl> <dbl>      <dbl>      <dbl>
#> 1 11284   1986      1   Male   <NA>  England 18-34   Suburban inc_q2           0    NA          1         NA
#> 2 10235   1986      0.5 Female <NA>  England 35-59   <NA>     inc_q1           0    NA          1         NA
#> 3 10200   1986      1   Male   <NA>  England 60+     Town     inc_q1           0    NA          2         NA
#> 4 13852   1986      0.5 Female <NA>  England 35-59   Suburban inc_q4           0    NA          2         NA
#> 5 13760   1986      1   Female <NA>  England 18-34   <NA>     <NA>             0    NA          2         NA
#> 6 13460   1986      1   Female <NA>  England 60+     <NA>     inc_q1           0    NA          2         NA
#> # ℹ 30 more variables: welffeetv2 <dbl>, sochelpv2 <dbl>, richlawv2 <dbl>, redistrbv2 <dbl>, unempjobv2 <dbl>,
#> #   dolefidlv2 <dbl>, morewelfv2 <dbl>, wealthv2 <dbl>, indust4v2 <dbl>, incomgapv2 <dbl>, dolev2 <dbl>,
#> #   exclusion_un_only04 <dbl>, welf_chavun_only04 <dbl>, depool_only04 <dbl>, ineq_accv2 <dbl>,
#> #   damlivesv2 <dbl>, incdiffsv2 <dbl>, ineqrichv2 <dbl>, majtaxv2_only04 <dbl>, soctaxv2_only04 <dbl>,
#> #   incdiffv2 <dbl>, benfrsecv2_only04 <dbl>, diffsnecv2 <dbl>, nousesecv2_only04 <dbl>, falseclmv2 <dbl>,
#> #   redist2v2_only04 <dbl>, socspnd1v2 <dbl>, socspnd4v2 <dbl>, taxraisev2 <dbl>, whyneedv5 <dbl>
```
...
#> Chain 1 Exception: cholesky_decompose: A is not symmetric. A[1,2] = nan, but A[2,1] = nan (in '/var/folders/y0/zvly4kr52k73ww89tjtm4_yw0000gn/T/Rtmpckmz3U/model-9c4519411f10.stan', line 55, column 4 to column 43)
...
#> Chain 1
#> Chain 1 Informational Message: The current Metropolis proposal is about to be rejected because of the following issue:
#> Chain 1 Exception: modgirt_probit_model_namespace::log_prob: Sigma_theta is not symmetric. Sigma_theta[1,2] = -9.57772e+16, but Sigma_theta[2,1] = -9.57772e+16 (in '/var/folders/y0/zvly4kr52k73ww89tjtm4_yw0000gn/T/Rtmpckmz3U/model-9c4519411f10.stan', line 49, column 2 to column 28)
#> Chain 1 If this warning occurs sporadically, such as for highly constrained variable types like covariance matrices, then the sampler is fine,
#> Chain 1 but if this warning occurs often then your model may be either severely ill-conditioned or misspecified.
#> Chain 1
#> Chain 1 Informational Message: The current Metropolis proposal is about to be rejected because of the following issue:
...
#> Chain 1
#> Chain 1 Informational Message: The current Metropolis proposal is about to be rejected because of the following issue:
#> Chain 1 Exception: modgirt_probit_model_namespace::log_prob: Sigma_theta is not symmetric. Sigma_theta[1,2] = -7.11431e+37, but Sigma_theta[2,1] = -7.11431e+37 (in '/var/folders/y0/zvly4kr52k73ww89tjtm4_yw0000gn/T/Rtmpckmz3U/model-9c4519411f10.stan', line 49, column 2 to column 28)
#> Chain 1 If this warning occurs sporadically, such as for highly constrained variable types like covariance matrices, then the sampler is fine,
#> Chain 1 but if this warning occurs often then your model may be either severely ill-conditioned or misspecified.
#> Chain 1
#> Chain 2 Informational Message: The current Metropolis proposal is about to be rejected because of the following issue:
#> Chain 2 Exception: cholesky_decompose: A is not symmetric. A[1,2] = nan, but A[2,1] = nan (in '/var/folders/y0/zvly4kr52k73ww89tjtm4_yw0000gn/T/Rtmpckmz3U/model-9c4519411f10.stan', line 55, column 4 to column 43)
...
#> Chain 2 but if this warning occurs often then your model may be either severely ill-conditioned or misspecified.
#> Chain 2
#> Chain 2 finished in 314.9 seconds.
#> Chain 1 finished in 343.2 seconds.
#> 
#> Both chains finished successfully.
#> Mean chain execution time: 329.1 seconds.
#> Total execution time: 343.3 seconds.
#> Warning: 18 of 500 (4.0%) transitions ended with a divergence.
...
#>  Length   :1830   Min.   :-330739.82   Min.   :-330739.89   Min.   : 0.00000   Min.   : 0.00000  
#>  N.unique :1830   1st Qu.:     -0.12   1st Qu.:     -0.13   1st Qu.: 0.02739   1st Qu.: 0.02688  
#>  N.blank  :   0   Median :      0.18   Median :      0.17   Median : 0.09009   Median : 0.08829  
#>  Min.nchar:   4   Mean   :   -180.25   Mean   :   -180.26   Mean   : 0.24878   Mean   : 0.24324  
#>  Max.nchar:  26   3rd Qu.:      1.00   3rd Qu.:      1.00   3rd Qu.: 0.39440   3rd Qu.: 0.37216  
#>                   Max.   :      4.33   Max.   :      4.31   Max.   :17.86612   Max.   :17.78379  
#>                                                                                                  
#>        q5                  q95                  rhat           ess_bulk         ess_tail     
#>  Min.   :-330771.71   Min.   :-330710.77   Min.   :0.9979   Min.   :  3.10   Min.   : 11.57  
#>  1st Qu.:     -0.79   1st Qu.:      0.00   1st Qu.:1.0059   1st Qu.: 11.67   1st Qu.: 73.59  
#>  Median :      0.00   Median :      0.67   Median :1.0126   Median : 96.55   Median :206.31  
#>  Mean   :   -180.64   Mean   :   -179.83   Mean   :1.1092   Mean   :171.62   Mean   :197.92  
#>  3rd Qu.:      0.67   3rd Qu.:      1.71   3rd Qu.:1.1244   3rd Qu.:280.75   3rd Qu.:313.19  
#>  Max.   :      3.94   Max.   :      4.80   Max.   :1.7884   Max.   :788.17   Max.   :493.26  
#>                                            NAs    :212      NAs    :212      NAs    :212
...
#> * iteration: 1 
#>    -----  objective function = 49.245 ----- 
#> 
#> * iteration: 2 
#>    -----  objective function = 47.648 ----- 
#> 
#> * iteration: 3 
#>    -----  objective function = 47.648 -----
...
#>       variable         mean                median                 sd                mad          
#>  Length   :1153   Min.   :-330739.82   Min.   :-330739.89   Min.   : 0.01076   Min.   : 0.01088  
#>  N.unique :1153   1st Qu.:     -0.30   1st Qu.:     -0.30   1st Qu.: 0.03056   1st Qu.: 0.03054  
#>  N.blank  :   0   Median :      0.46   Median :      0.46   Median : 0.08398   Median : 0.08102  
#>  Min.nchar:   4   Mean   :   -286.20   Mean   :   -286.21   Mean   : 0.15547   Mean   : 0.14973  
#>  Max.nchar:  17   3rd Qu.:      1.53   3rd Qu.:      1.53   3rd Qu.: 0.21027   3rd Qu.: 0.20149  
#>                   Max.   :      4.33   Max.   :      4.31   Max.   :17.86612   Max.   :17.78379  
#>        q5                  q95                  rhat           ess_bulk         ess_tail     
#>  Min.   :-330771.71   Min.   :-330710.77   Min.   :0.9974   Min.   : 16.27   Min.   : 67.63  
#>  1st Qu.:     -0.61   1st Qu.:     -0.01   1st Qu.:1.0022   1st Qu.: 96.96   1st Qu.:196.92  
#>  Median :      0.26   Median :      0.63   Median :1.0075   Median :238.86   Median :293.72  
#>  Mean   :   -286.45   Mean   :   -285.94   Mean   :1.0095   Mean   :258.10   Mean   :278.60  
#>  3rd Qu.:      1.19   3rd Qu.:      1.79   3rd Qu.:1.0124   3rd Qu.:347.72   3rd Qu.:375.40  
#>  Max.   :      3.94   Max.   :      4.80   Max.   :1.1093   Max.   :788.17   Max.   :515.32
...
use_rvar <- sort_modgirt(modgirt_id) |> sign_modgirt(1)
#> Error in `apply()`:
...
#> [1] "1" "2" "3" "4" "5" "6"
#> 
#> Warning: Coercing 1 2 3 4 5 6 ... to integer
...
![plot of chunk visualize](visualize-1.png)
